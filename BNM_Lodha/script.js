...
function openWhatsApp() {
    ...
    const message = 'Hello! I am interested in Lodha properties. Please provide more information about available projects.';
...
function sendEmailNotification(name, email, phone, inquiry, message, consent) {
    console.log('Email notification sent to:', {
        to: 'himanshu@lodhasalesoffice.co.in',
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Lodha Sales Office website loaded successfully!');
