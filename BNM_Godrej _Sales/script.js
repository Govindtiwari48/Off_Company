...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbyzokh2V28BLZK6YSlEst_3faJ_HleytHziQnLYYk1R-Lsaw37MmUgsvgW_w6WDzuUNBg/exec'; // Replace with your actual Google Apps Script URL
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Premier Real Estate Group website loaded successfully!');
