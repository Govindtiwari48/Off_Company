...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbwW46cqtr_JlnyNkwqLUo5w1YHZj0CITZO9Cn9o3cuPZak-2LcVntqpxLYlkzklcNop/exec'; // Replace with your actual Google Apps Script URL
...
function sendEmailNotification(name, email, phone, inquiry, message, consent) {
    console.log('Email notification sent to:', {
        to: 'arpit@bricksandmilestones.shop',
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Milestone Realty Group website loaded successfully!');
