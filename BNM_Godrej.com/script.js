...
function openWhatsApp() {
    ...
    const message = 'Hello! I am interested in Godrej properties. Please provide more information about available plots and developments.';
...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbx72renxZqx0x8ih-GWNRw4cyHJTV-4CTe5i4PsUsKlEgLg3GtpvE1xLlB11UnjiHQe/exec'; // Replace with your actual Google Apps Script URL
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Godrej Plot Sale website loaded successfully!');
